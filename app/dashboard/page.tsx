...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Stats Grid - Ganti Card dengan div */}
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-center mt-2">
                    <IconTrendingUp className="h-4 w-4 text-gray-600 dark:text-gray-400 mr-1" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Activities - Ganti Card dengan div */}
                ...
                <div key={activity.id} className="flex items-start space-x-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                  <div className="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center">
                    {activity.type === 'incoming' ? (
                      <IconMail className="h-5 w-5 text-gray-600 dark:text-gray-400" />
                    ) : (
                      <IconSend className="h-5 w-5 text-gray-600 dark:text-gray-400" />
                    )}
                  </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div className="bg-gray-600 dark:bg-gray-400 h-2 rounded-full" style={{width: '89%'}}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div className="bg-gray-600 dark:bg-gray-400 h-2 rounded-full" style={{width: '84%'}}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                    <div className="bg-gray-600 dark:bg-gray-400 h-2 rounded-full" style={{width: '91%'}}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 pt-4">
              <div className="space-y-3">
                <Link href="/letters/incoming/create">
                  <Button 
                    className="w-full justify-start bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300"
                    variant="flat"
